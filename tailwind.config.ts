	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'glow': {
					'0%': { boxShadow: '0 0 5px rgba(29, 78, 216, 0.5)' },
					'50%': { boxShadow: '0 0 20px rgba(29, 78, 216, 0.8)' },
					'100%': { boxShadow: '0 0 5px rgba(29, 78, 216, 0.5)' }
				},
				'pulse-blue': {
					'0%, 100%': { opacity: '0.6' },
					'50%': { opacity: '1' }
            ...
            boxShadow: {
                'apple-card': '0 4px 30px rgba(0, 0, 0, 0.1), 0 1px 3px rgba(0, 0, 0, 0.05)',
                'apple-glow': '0 0px 20px rgba(59, 130, 246, 0.5)'
            }
		}
	},
